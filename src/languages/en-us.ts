...
export const strings = {
  ...
  ADMIN_SETTINGS_USERS_EDIT_GROUP_ADD_REMOVE_USER_NOT_FOUND: 'User not found.',
  ADMIN_SETTINGS_USERS_EDIT_GROUP_ADD_REMOVE_GROUP_NOT_FOUND: 'Group not found.',
  ADMIN_SETTINGS_USERS_EDIT_GROUP_ADD_SUCCESS: (name, group) => `${name} is now a member of ${group}.`,
  ADMIN_SETTINGS_USERS_EDIT_GROUP_REMOVE_SUCCESS: (name, group) => `${name} has been removed from ${group}.`,
  ...
  ADMIN_USER_EDIT_GROUPS_REMOVE: 'Remove',
  ADMIN_USER_EDIT_GROUPS_ADD: 'Add',
  ADMIN_USER_EDIT_GROUPS_CREATE_HEADER: 'New Group',
  ADMIN_USER_EDIT_GROUPS_CREATE_DISPLAY_NAME: 'Name',
  ADMIN_USER_EDIT_GROUPS_CREATE_DISPLAY_NAME_PLACEHOLDER: 'Family',
  ADMIN_USER_EDIT_GROUPS_CREATE: 'Add New Group',
  ...
  ADMIN_USER_EDIT_MANAGERS: 'Managers',
  ADMIN_USER_EDIT_MANAGED_STATUS: name => `${name} is a managed user.`,
  ADMIN_USER_EDIT_NOT_MANAGED: name => `${name} is not a managed user.`,
  ADMIN_USER_EDIT_NO_MANAGERS: 'No managers assigned.',
  ADMIN_USER_EDIT_MANAGERS_ADD: 'Add Manager',
  ADMIN_USER_EDIT_MANAGERS_ADD_USER: 'User to Add as Manager',
  ADMIN_USER_EDIT_MANAGERS_LEVEL: 'Manager Level',
  ADMIN_USER_EDIT_MANAGERS_LEVEL_FULL: 'Full Manager',
  ADMIN_USER_EDIT_MANAGERS_LEVEL_COLLABORATOR: 'Collaborator',
  ADMIN_USER_EDIT_MANAGERS_REMOVE: 'Remove',
  ADMIN_USER_EDIT_MANAGERS_MAKE_FULL: 'Make Full',
  ADMIN_USER_EDIT_MANAGERS_MAKE_COLLABORATOR: 'Make Collaborator',
  ADMIN_SETTINGS_MANAGERS_INVALID_INPUT: 'Invalid manager ID or level provided.',
  ADMIN_SETTINGS_MANAGERS_INVALID_LEVEL: 'Invalid manager level.',
  ADMIN_SETTINGS_MANAGERS_ADD_SUCCESS: (managerId, level) => `Successfully added ${managerId} as ${level} manager.`,
  ADMIN_SETTINGS_MANAGERS_REMOVE_SUCCESS: managerId => `Successfully removed ${managerId} as manager.`,
  ADMIN_SETTINGS_MANAGERS_LEVEL_CHANGE_SUCCESS: (managerId, newLevel) => `Successfully changed ${managerId} to ${newLevel} manager.`,
  ADMIN_USER_EDIT_USERNAME: 'Username',
  
  // Profile collaborator management
  PROFILE_COLLABORATORS_HEADER: 'Collaborators',
  PROFILE_COLLABORATORS_DESCRIPTION: 'Collaborators can help manage your wishlist by adding items for you.',
  PROFILE_COLLABORATORS_ADD_USER: 'Add Collaborator',
  PROFILE_COLLABORATORS_SELECT_USER: 'Select User',
  PROFILE_COLLABORATORS_ADD: 'Add',
  PROFILE_COLLABORATORS_REMOVE: 'Remove',
  PROFILE_COLLABORATORS_NO_COLLABORATORS: 'No collaborators added.',
  PROFILE_COLLABORATORS_INVALID_INPUT: 'Please select a valid user to add as collaborator.',
  PROFILE_COLLABORATORS_ADD_SUCCESS: collaboratorId => `Successfully added ${collaboratorId} as collaborator.`,
  PROFILE_COLLABORATORS_REMOVE_SUCCESS: collaboratorId => `Successfully removed ${collaboratorId} as collaborator.`,
  PROFILE_COLLABORATORS_NOT_FOUND: 'Collaborator not found.',
  PROFILE_COLLABORATORS_CANNOT_REMOVE_FULL: 'You can only remove collaborators, not full managers. Contact an admin to remove full managers.',
  
  // Manager dashboard
  MANAGE_TITLE: 'Manager Dashboard',
  MANAGE_DESCRIPTION: 'Manage users and their collaborators',
  MANAGE_USERS_YOU_MANAGE: 'Users You Manage',
  MANAGE_MANAGE_USER: 'Manage',
  MANAGE_VIEW_WISHLIST: 'View Wishlist',
  MANAGE_NO_MANAGED_USERS: 'No Managed Users',
  MANAGE_NO_MANAGED_USERS_DESCRIPTION: 'You are not currently managing any users. Only full managers can access this dashboard.',
  MANAGE_BACK_TO_PROFILE: 'Back to Profile',
  MANAGE_INSUFFICIENT_PERMISSIONS: 'Insufficient permissions to manage this user.',
  MANAGE_INVALID_INPUT: 'Invalid manager ID or level provided.',
  MANAGE_INVALID_LEVEL: 'Invalid manager level.',
  MANAGE_ADD_SUCCESS: (managerId, level) => `Successfully added ${managerId} as ${level} manager.`,
  MANAGE_REMOVE_SUCCESS: managerId => `Successfully removed ${managerId} as manager.`,
  MANAGE_LEVEL_CHANGE_SUCCESS: (managerId, newLevel) => `Successfully changed ${managerId} to ${newLevel} manager.`,
  
  // Individual user management
  MANAGE_USER_TITLE: name => `Managing ${name}`,
  MANAGE_USER_DESCRIPTION: name => `Manage managers and collaborators for ${name}`,
  MANAGE_USER_CURRENT_MANAGERS: 'Current Managers',
  MANAGE_USER_NO_MANAGERS: 'No managers assigned.',
  MANAGE_USER_ADD_MANAGER: 'Add Manager',
  MANAGE_USER_SELECT_USER: 'Select User',
  MANAGE_USER_SELECT_USER_PLACEHOLDER: 'Choose a user...',
  MANAGE_USER_MANAGER_LEVEL: 'Manager Level',
  MANAGE_USER_LEVEL_COLLABORATOR: 'Collaborator',
  MANAGE_USER_LEVEL_FULL: 'Full Manager',
  MANAGE_USER_ADD: 'Add Manager',
  MANAGE_USER_NO_AVAILABLE_USERS: 'No additional users available to add as managers.',
  MANAGE_USER_ACTIONS: 'Actions',
  MANAGE_BACK_TO_DASHBOARD: 'Back to Dashboard',
  MANAGE_REMOVE_MANAGER: 'Remove',
  MANAGE_MAKE_COLLABORATOR: 'Make Collaborator',
  MANAGE_MAKE_FULL: 'Make Full',
