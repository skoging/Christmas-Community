...
const _NOT_LOCALIZED = key => `${key} har ikke blitt oversatt til norsk enda.`
...
export const strings = {
  ...
  ADMIN_SETTINGS_USERS_EDIT_GROUP_ADD_REMOVE_USER_NOT_FOUND: 'Brukeren ble ikke funnet.',
  ADMIN_SETTINGS_USERS_EDIT_GROUP_ADD_REMOVE_GROUP_NOT_FOUND: 'Gruppen ble ikke funnet.',
  ADMIN_SETTINGS_USERS_EDIT_GROUP_ADD_SUCCESS: (name, group) => `${name} er nå en en del av ${group}.`,
  ADMIN_SETTINGS_USERS_EDIT_GROUP_REMOVE_SUCCESS: (name, group) => `${name} er nå fjernet fra ${group}.`,
  ...
  ADMIN_USER_EDIT_GROUPS_REMOVE: 'Fjern',
  ADMIN_USER_EDIT_GROUPS_ADD: 'Legg til',
  ADMIN_USER_EDIT_GROUPS_CREATE_HEADER: 'Ny gruppe',
  ADMIN_USER_EDIT_GROUPS_CREATE_DISPLAY_NAME: 'Navn',
  ADMIN_USER_EDIT_GROUPS_CREATE_DISPLAY_NAME_PLACEHOLDER: 'Hansen',
  ADMIN_USER_EDIT_GROUPS_CREATE: 'Legg til ny gruppe',
  ...
  ADMIN_USER_EDIT_MANAGERS: 'Forvaltere',
  ADMIN_USER_EDIT_MANAGED_STATUS: name => `${name} er en forvaltet bruker.`,
  ADMIN_USER_EDIT_NOT_MANAGED: name => `${name} er ikke en forvaltet bruker.`,
  ADMIN_USER_EDIT_NO_MANAGERS: 'Ingen forvaltere tildelt.',
  ADMIN_USER_EDIT_MANAGERS_ADD: 'Legg til forvalter',
  ADMIN_USER_EDIT_MANAGERS_ADD_USER: 'Bruker som skal legges til som forvalter',
  ADMIN_USER_EDIT_MANAGERS_LEVEL: 'Forvalternivå',
  ADMIN_USER_EDIT_MANAGERS_LEVEL_FULL: 'Full forvalter',
  ADMIN_USER_EDIT_MANAGERS_LEVEL_COLLABORATOR: 'Samarbeider',
  ADMIN_USER_EDIT_MANAGERS_REMOVE: 'Fjern',
  ADMIN_USER_EDIT_MANAGERS_MAKE_FULL: 'Gjør til full',
  ADMIN_USER_EDIT_MANAGERS_MAKE_COLLABORATOR: 'Gjør til samarbeider',
  ADMIN_SETTINGS_MANAGERS_INVALID_INPUT: 'Ugyldig forvalter-ID eller nivå oppgitt.',
  ADMIN_SETTINGS_MANAGERS_INVALID_LEVEL: 'Ugyldig forvalternivå.',
  ADMIN_SETTINGS_MANAGERS_ADD_SUCCESS: (managerId, level) => `${managerId} ble lagt til som ${level} forvalter.`,
  ADMIN_SETTINGS_MANAGERS_REMOVE_SUCCESS: managerId => `${managerId} ble fjernet som forvalter.`,
  ADMIN_SETTINGS_MANAGERS_LEVEL_CHANGE_SUCCESS: (managerId, newLevel) => `${managerId} ble endret til ${newLevel} forvalter.`,
  ADMIN_USER_EDIT_USERNAME: 'Brukernavn',
  
  // Profile collaborator management
  PROFILE_COLLABORATORS_HEADER: 'Samarbeidspartnere',
  PROFILE_COLLABORATORS_DESCRIPTION: 'Samarbeidspartnere kan hjelpe til med å administrere ønskelisten din ved å legge til elementer for deg.',
  PROFILE_COLLABORATORS_ADD_USER: 'Legg til samarbeidspartner',
  PROFILE_COLLABORATORS_SELECT_USER: 'Velg bruker',
  PROFILE_COLLABORATORS_ADD: 'Legg til',
  PROFILE_COLLABORATORS_REMOVE: 'Fjern',
  PROFILE_COLLABORATORS_NO_COLLABORATORS: 'Ingen samarbeidspartnere lagt til.',
  PROFILE_COLLABORATORS_INVALID_INPUT: 'Vennligst velg en gyldig bruker å legge til som samarbeidspartner.',
  PROFILE_COLLABORATORS_ADD_SUCCESS: collaboratorId => `${collaboratorId} ble lagt til som samarbeidspartner.`,
  PROFILE_COLLABORATORS_REMOVE_SUCCESS: collaboratorId => `${collaboratorId} ble fjernet som samarbeidspartner.`,
  PROFILE_COLLABORATORS_NOT_FOUND: 'Samarbeidspartner ikke funnet.',
  PROFILE_COLLABORATORS_CANNOT_REMOVE_FULL: 'Du kan bare fjerne samarbeidspartnere, ikke fulle forvaltere. Kontakt en administrator for å fjerne fulle forvaltere.',
  
  // Manager dashboard
  MANAGE_TITLE: 'Forvalter-dashboard',
  MANAGE_DESCRIPTION: 'Administrer brukere og deres samarbeidspartnere',
  MANAGE_USERS_YOU_MANAGE: 'Brukere du forvalter',
  MANAGE_MANAGE_USER: 'Administrer',
  MANAGE_VIEW_WISHLIST: 'Vis ønskeliste',
  MANAGE_NO_MANAGED_USERS: 'Ingen forvaltede brukere',
  MANAGE_NO_MANAGED_USERS_DESCRIPTION: 'Du forvalter for øyeblikket ingen brukere. Bare fulle forvaltere kan få tilgang til dette dashbordet.',
  MANAGE_BACK_TO_PROFILE: 'Tilbake til profil',
  MANAGE_INSUFFICIENT_PERMISSIONS: 'Utilstrekkelige tillatelser til å administrere denne brukeren.',
  MANAGE_INVALID_INPUT: 'Ugyldig forvalter-ID eller nivå oppgitt.',
  MANAGE_INVALID_LEVEL: 'Ugyldig forvalternivå.',
  MANAGE_ADD_SUCCESS: (managerId, level) => `${managerId} ble lagt til som ${level} forvalter.`,
  MANAGE_REMOVE_SUCCESS: managerId => `${managerId} ble fjernet som forvalter.`,
  MANAGE_LEVEL_CHANGE_SUCCESS: (managerId, newLevel) => `${managerId} ble endret til ${newLevel} forvalter.`,
  
  // Individual user management
  MANAGE_USER_TITLE: name => `Administrerer ${name}`,
  MANAGE_USER_DESCRIPTION: name => `Administrer forvaltere og samarbeidspartnere for ${name}`,
  MANAGE_USER_CURRENT_MANAGERS: 'Nåværende forvaltere',
  MANAGE_USER_NO_MANAGERS: 'Ingen forvaltere tildelt.',
  MANAGE_USER_ADD_MANAGER: 'Legg til forvalter',
  MANAGE_USER_SELECT_USER: 'Velg bruker',
  MANAGE_USER_SELECT_USER_PLACEHOLDER: 'Velg en bruker...',
  MANAGE_USER_MANAGER_LEVEL: 'Forvalternivå',
  MANAGE_USER_LEVEL_COLLABORATOR: 'Samarbeidspartner',
  MANAGE_USER_LEVEL_FULL: 'Full forvalter',
  MANAGE_USER_ADD: 'Legg til forvalter',
  MANAGE_USER_NO_AVAILABLE_USERS: 'Ingen flere brukere tilgjengelig for å legge til som forvaltere.',
  MANAGE_USER_ACTIONS: 'Handlinger',
  MANAGE_BACK_TO_DASHBOARD: 'Tilbake til dashboard',
  MANAGE_REMOVE_MANAGER: 'Fjern',
  MANAGE_MAKE_COLLABORATOR: 'Gjør til samarbeidspartner',
  MANAGE_MAKE_FULL: 'Gjør til full',
  ...
  LOGIN_GOOGLE_BUTTON: 'Logg inn med Google',
  LOGIN_INCORRECT_PASSWORD: 'Feil passord',
  LOGIN_INCORRECT_USERNAME: 'Feil brukernavn',
  LOGIN_PASSWORD_PLACEHOLDER: 'pa$$ord!',
  LOGIN_PASSWORD: 'Passord',
  LOGIN_SSO_LINK_FAILURE: 'Kunne ikke koble til konto',
  LOGIN_SSO_LINK_FAILURE_ACCOUNT_EXISTS: 'Den eksterne kontoen er allerede koblet til en annen konto på denne siden!',
  LOGIN_SSO_LINK_SUCCESS: 'Konto koblet til',
  LOGIN_SSO_UNKNOWN_USER: 'Ukjent bruker',
  LOGIN_SSO_UNLINK_FAILURE: 'Kunne ikke koble fra konto',
  LOGIN_SSO_UNLINK_SUCCESS: 'Konto koblet fra',
  ...
  NOTE_SUCCESS: 'Lagret!',
  NOTE_URL: 'Lenke',
  PROFILE_COAT_SIZE: 'Jakke-/kåpe-/dressstørrelse',
  PROFILE_DRESS_SIZE: 'Kjolestørrelse',
  PROFILE_HAT_SIZE: 'Hodeplaggstørrelse',
  PROFILE_HEADER: 'Profil',
  PROFILE_PANTS_SIZE: 'Buksestørrelse',
  ...
  PROFILE_PHONE_MODEL: 'Telefonmodell',
  PROFILE_RING_SIZE: 'Ringstørrelse',
  ...
  PROFILE_SECURITY_LINK_GOOGLE: 'Koble til Google-konto',
  PROFILE_SECURITY_UNLINK_GOOGLE: 'Koble fra Google-konto',
  PROFILE_SECURITY: 'Sikkerhet',
  PROFILE_SHARED_INFORMATION: 'Delt informasjon',
  PROFILE_SHIRT_SIZE: 'Skjortestørrelse',
  PROFILE_SHOE_SIZE: 'Skostørrelse',
  PROFILE_SWEATER_SIZE: 'Bluse-/genserstørrelse',
  PROFILE_TITLE: name => `Profilinnstillinger - ${name}`,
  PROFILE_UPDATE_INFO_SUCCESS: 'Delt informasjon oppdatert!',
